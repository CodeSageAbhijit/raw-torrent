...
export function Footer() {
  return (
    <footer className="w-full border-t border-foreground/10 bg-gradient-to-b from-background to-background/95">
      <div className="w-full flex items-center justify-center mx-auto py-8 px-4">
